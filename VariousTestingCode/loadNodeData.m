function [rxSymbols, rxSymbols_cut, rxSymbols_ref, rxSymbols_cut_ref, testName] = loadNodeData (directory, ref_node, folder_index)
...
SAMPLERATE = 192000;
CHUNKCOUNT = 5;
NOSAMPLES = SAMPLERATE*CHUNKCOUNT;
N = 5;
...
Reffered_Start = StartT - StartT(ref_node)
